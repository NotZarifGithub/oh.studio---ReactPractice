...
const styles = {
    ...
    heroBoxWidth: "max-w-[750px] mx-auto",

    paddingX: "sm:px-[40px] px-[20px]",
    paddingY: "sm:py-[40px] py-[20px]",
    heroPadding: "sm:p-[40px] p-[20px]",
    ...
    roundedborder: "rounded-full py-[6px] px-[10px] bg-tertiary",
}
